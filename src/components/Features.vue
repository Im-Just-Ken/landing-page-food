  ...
  <section class="my-15 mt-20 sm:mt-20 md:mt-32 lg:mt-32">
    ...
    <div class="w-full max-w-[1440px] mx-auto px-4 sm:px-6 flex justify-center">
      <ul class="w-full flex flex-wrap justify-center gap-6">
        <li
          class="feature-card relative bg-cover bg-center w-[340px] sm:w-[300px] md:w-[300px] lg:w-[300px] h-76 rounded-xl p-4 shadow-lg overflow-hidden flex-col motion-opacity-in-0 motion-translate-y-in-50 motion-delay-200"
